...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.gambit_combo)
        self.init_cost_label = QtWidgets.QLabel(self.frame_2)
        self.init_cost_label.setObjectName("init_cost_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.init_cost_label)
