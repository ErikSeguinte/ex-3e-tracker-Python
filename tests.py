...
class MyTest(unittest.TestCase):
    ...
    def test_withering(self):
        ...
        known_values = (
            ...
            (5, 5, -9, False, True, True),
            (10, 7, -5, False, True, False),  # New Round
            (0, 7, 4, False, False, True),  # test for missed withering attacks.
        )
        for damage, n_attacker_init, n_defender_init, a_crash, \
            d_crash, has_gone in known_values:
            print("")
            print("")
            combatants = (0, 1)
